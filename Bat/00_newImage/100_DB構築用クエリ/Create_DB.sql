...
CREATE TABLE `バリエーション選択肢定義` (
	...
	`色` MEDIUMTEXT NULL COLLATE 'utf8_general_ci',
	`サイズ` MEDIUMTEXT NULL COLLATE 'utf8_general_ci'
) ENGINE=MyISAM;
...
--  テーブル new_image.商品在庫 の構造をダンプしています
CREATE TABLE IF NOT EXISTS `商品在庫` (
  `商品番号` varchar(200) DEFAULT NULL,
  `商品在庫_日本語` varchar(200) DEFAULT NULL,
  `商品在庫_英語` varchar(200) DEFAULT NULL,
  `商品在庫_数量` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
